  ...
  return (
    <div style={{ padding: '115px 20px 100px', background: 'transparent', minHeight: '100dvh' }}>
      ...
      <div style={{ 
        ...
        <h1 style={{ fontSize: 24, fontWeight: 800, color: 'var(--app-text)', letterSpacing: '-0.5px' }}>Activity Summary</h1>
        <p style={{ fontSize: 13, color: 'var(--app-muted)', marginTop: 4, fontWeight: 600 }}>Analyzing performance patterns</p>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 14, marginBottom: 32 }}>
        <div style={{ 
          ...
          borderRadius: 28, padding: '24px', color: '#fff', 
        ...
        <div style={{ background: 'var(--app-card)', borderRadius: 28, padding: '24px', border: '1px solid var(--app-border)', boxShadow: '0 4px 12px rgba(0,0,0,0.02)' }}>
          <div style={{ color: '#F59E0B', marginBottom: 12, background: 'rgba(245, 158, 11, 0.1)', width: 44, height: 44, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <TrendingUp size={22} />
          </div>
